...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
        return (
                <Dialog.Root>
                        <Dialog.Trigger className='relative flex flex-col bg-slate-800 gap-3 p-5 outline-none  rounded-md overflow-hidden hover:ring-2 hover:ring-slate-600 text-left focus-visible:ring-1 focus-visible:ring-lime-400'>
